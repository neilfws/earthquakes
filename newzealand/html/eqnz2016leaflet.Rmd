...
## Introduction
This document was inspired by Neil Saunders' [recent post](https://nsaunders.wordpress.com/2016/11/24/putting-data-on-maps-using-r-easier-than-ever/) mapping New Zealand earthquake data. This document shows how to make an interactive map using the [leaflet](https://rstudio.github.io/leaflet/) package for R.
...
```{r get-map}
NZ.map = leaflet(width='95%', height=600) %>% 
  addProviderTiles('Stamen.Terrain') %>% 
  setView(lat=-41.7305615, 
          lng=172.8773913, 
          zoom=6)
```
...
NZ.map %>% 
  addCircles(data=geonet_large, 
             radius=sqrt(mag)*1000,
             color=colors(mag), 
